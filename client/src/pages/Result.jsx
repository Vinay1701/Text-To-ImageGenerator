...
const Result = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        if (input) {
            ...
            console.log('Generated Image URL:', generatedImage); // Debug what generateImage returns
            if (generatedImage) {
                setIsImageLoaded(true);
                setImage(generatedImage);
                console.log('Image set to:', generatedImage); // Debug what image is set to
            } else {
                setIsImageLoaded(true);
                setImage(assets.sample_img_2);
                console.log('Fallback image set to:', assets.sample_img_2); // Debug fallback
            }
        }
        setLoading(false);
    };
