            ...
            <div>
                {user ? (
                    <div className="flex items-center gap-2 sm:gap-3">
                        {/* Show credits without a clickable buy button */}
                        <div className="flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full">
                    ...
                    <div className="flex items-center gap-2 sm:gap-5">
                        {/* Remove Pricing link since payments are bypassed */}
                        <button
